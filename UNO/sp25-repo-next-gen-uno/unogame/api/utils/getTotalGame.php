...
if (isset($_GET['action']) && $_GET['action'] === 'getTotalGame') {
    ...
    $query = "SELECT total_games FROM users WHERE username = ?";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo json_encode(["success" => true, "totalgames" => $row['total_games']]);
    } 
    $stmt->close();
}
